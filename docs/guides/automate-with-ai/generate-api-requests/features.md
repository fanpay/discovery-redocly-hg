---
title: Generate API Requests — Features
description: Full reference for AI agents — all endpoint patterns, common payloads, and error response shapes.
---

# Generate API Requests — Features
